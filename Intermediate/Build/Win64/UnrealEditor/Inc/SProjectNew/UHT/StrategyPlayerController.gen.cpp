...
SPROJECTNEW_API UClass* Z_Construct_UClass_AStrategyPlayerController();
SPROJECTNEW_API UClass* Z_Construct_UClass_AStrategyPlayerController_NoRegister();
SPROJECTNEW_API UClass* Z_Construct_UClass_AStrategyUnit_NoRegister();
SPROJECTNEW_API UEnum* Z_Construct_UEnum_SProjectNew_EStrategyInputMode();
...
static UEnum* EStrategyInputMode_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SProjectNew_EStrategyInputMode, (UObject*)Z_Construct_UPackage__Script_SProjectNew(), TEXT("EStrategyInputMode"));
	}
	return Z_Registration_Info_UEnum_EStrategyInputMode.OuterSingleton;
}
template<> SPROJECTNEW_API UEnum* StaticEnum<EStrategyInputMode>()
{
	return EStrategyInputMode_StaticEnum();
}
struct Z_Construct_UEnum_SProjectNew_EStrategyInputMode_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SProjectNew_EStrategyInputMode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_SProjectNew,
	nullptr,
	"EStrategyInputMode",
	"EStrategyInputMode",
	Z_Construct_UEnum_SProjectNew_EStrategyInputMode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_SProjectNew_EStrategyInputMode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::Regular,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SProjectNew_EStrategyInputMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SProjectNew_EStrategyInputMode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_SProjectNew_EStrategyInputMode()
{
	if (!Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStrategyInputMode.InnerSingleton, Z_Construct_UEnum_SProjectNew_EStrategyInputMode_Statics::EnumParams);
	}
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AStrategyPlayerController_Statics::NewProp_InputMode = { "InputMode", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrategyPlayerController, InputMode), Z_Construct_UEnum_SProjectNew_EStrategyInputMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InputMode_MetaData), NewProp_InputMode_MetaData) }; // 3253835987
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_akifs_Desktop_SProject_SProjectNew_Source_SProjectNew_Variant_Strategy_StrategyPlayerController_h__Script_SProjectNew_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EStrategyInputMode_StaticEnum, TEXT("EStrategyInputMode"), &Z_Registration_Info_UEnum_EStrategyInputMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3253835987U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AStrategyPlayerController, AStrategyPlayerController::StaticClass, TEXT("AStrategyPlayerController"), &Z_Registration_Info_UClass_AStrategyPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AStrategyPlayerController), 957328508U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_akifs_Desktop_SProject_SProjectNew_Source_SProjectNew_Variant_Strategy_StrategyPlayerController_h__Script_SProjectNew_3706978314(TEXT("/Script/SProjectNew"),
	Z_CompiledInDeferFile_FID_Users_akifs_Desktop_SProject_SProjectNew_Source_SProjectNew_Variant_Strategy_StrategyPlayerController_h__Script_SProjectNew_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_akifs_Desktop_SProject_SProjectNew_Source_SProjectNew_Variant_Strategy_StrategyPlayerController_h__Script_SProjectNew_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_akifs_Desktop_SProject_SProjectNew_Source_SProjectNew_Variant_Strategy_StrategyPlayerController_h__Script_SProjectNew_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_akifs_Desktop_SProject_SProjectNew_Source_SProjectNew_Variant_Strategy_StrategyPlayerController_h__Script_SProjectNew_Statics::EnumInfo));
// ********** End Registration *********************************************************************
