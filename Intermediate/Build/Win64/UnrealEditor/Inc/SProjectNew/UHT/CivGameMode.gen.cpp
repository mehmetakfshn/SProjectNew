...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ACivGameMode_Statics::NewProp_AICivs = { "AICivs", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACivGameMode, AICivs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AICivs_MetaData), NewProp_AICivs_MetaData) }; // 2731982406
...
struct Z_CompiledInDeferFile_FID_Users_akifs_Desktop_SProject_SProjectNew_Source_SProjectNew_CivGameMode_h__Script_SProjectNew_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACivGameMode, ACivGameMode::StaticClass, TEXT("ACivGameMode"), &Z_Registration_Info_UClass_ACivGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACivGameMode), 194253640U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_akifs_Desktop_SProject_SProjectNew_Source_SProjectNew_CivGameMode_h__Script_SProjectNew_1583902951(TEXT("/Script/SProjectNew"),
